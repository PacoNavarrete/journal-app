const tempData = [
  {
    title: 'Enero',
    description: 'Exercitation cillum irure elit consectetur.',
  },
  {
    title: 'Febrero',
    description: 'Exercitation cillum irure elit consectetur.',
...
export const SideBar = () => {
  return (
    <div className='min-w-[300px] min-h-[800px] h-auto bg-white border-2 border-black rounded-md p-5'>
      <h5 className='text-xl mb-2'>Paco Navarrete</h5>
      <hr />
      <div>
        {tempData.map((item) => (
          <div key={item.title}>
